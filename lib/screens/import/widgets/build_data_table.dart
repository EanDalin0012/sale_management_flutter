...
class BuildDataTable extends StatefulWidget {
  ...
  const BuildDataTable({Key? key, required this.vData, required this.onChanged}) : super(key: key);
        ...
        rows: widget.vData.map((e) {
          ...
          return DataRow(
              cells: <DataCell>[
                ...
                DataCell(Text(e[ImportAddKey.quantity].toString(), style: textStyle)),
                DataCell(Text(e[ImportAddKey.total].toString() + ' \$', style: textStyle)),
