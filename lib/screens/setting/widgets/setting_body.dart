          ...
          Container(
            child: Column(
              ...
              children: <Widget>[
                ...
                _buildListTile(
                    title: 'Ean Dalin', svgIcon: 'assets/icons/User.svg'),
                Divider(
                  height: 2,
                ),
                Divider(),
                _buildListTile(title: '20201548',
                    svgIcon: 'assets/icons/featured_play_list_black_24dp.svg'),
                Divider(
                  height: 2,
                ),
              ],
          ...
          this.vStock != null ? InkWell(
            ...
            child: Container(
              ...
              child: Row(
                children: <Widget>[
                  FaIcon(
                    FontAwesomeIcons.database, color: ColorsUtils.iConColor(),),
                  Padding(
                      padding: EdgeInsets.only(left: 15),
                      child: Text(
                        '${this.vStock[StockKey.name]}', style: style,))
                ],
              ),
            ),
          ) : Container(),
