...
class BuildDataTableSale extends StatefulWidget {
  ...
  const BuildDataTableSale({Key? key, required this.vData, required this.onChanged}) : super(key: key);
                    ...
                    Row(
                        children: <Widget>[
                          Container(
                              ...
                              child: PrefixProduct(url:  product[ProductKey.url].toString())),
                          SizedBox(width: 10),
                          Text(product[ProductKey.name].toString(), style: textStyle)
                        ]
                    )
                ),
                DataCell(Text(packageProduct[PackageProductKey.name].toString(), style: textStyle)),
                DataCell(Text(e[SaleAddItemKey.quantity].toString(), style: textStyle)),
                DataCell(Text(e[SaleAddItemKey.total].toString() + ' \$', style: textStyle)),
